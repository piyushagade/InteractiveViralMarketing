...
<div  style="position: fixed; right: 20%; top: 70%; z-index:100;"><a href="ic_algo?edge_in='''+edge_in+'''&&seedlist='''+seedlist+'''" class="btn btn-default btn-lg" style="padding: 15px;">Proceed</a></div>
...
<div style="position: fixed; z-index: 9999; margin:50px"><h2><span style="color: #42dca3">Independent Cascasding</span></h2>
...
<div style="text-align:justify; padding:20px; border: dashed; width: 400px;  z-index:100; border-color: #787;"><p>The edge weights are the probabilities of getting influenced by neighbours.</p></div>
</div>
...
def algo(edge_in, seedlist):
        ...
        print( start_Influence(DG, activated_Nodes))
...
<div style="position: fixed; right: 20%; top: 70%; z-index:100;"><a href="ic_algo?edge_in='''+edge_in+'''&&seedlist='''+seedlist+'''" class="btn btn-default btn-lg" style="padding: 13px;">Rework</a></div>
<div style="position: fixed; right: 20%; top: 78%; z-index:100;"><a href="ic_land?edge_in='''+edge_in+'''&&seedlist='''+seedlist+'''" class="btn btn-default btn-lg" style="padding: 12px;">Go Back</a></div>
...
<center>
<div style="position: fixed; border-style: dashed;    width:98%;    height:28%    border-width: 2px;    border-color:#42dca3;    margin-left:auto;    margin-right:auto;  align="center">
<div style="position: fixed; z-index: 9999; margin:50px"><h2><span style="color: #42dca3">Independent Cascading</span></h2>
<font color="#FFF">Seeds selected: <a id="selectedseedlistdiv">'''+seed_str+'''</a></font>
<!--<br><font color="#FFF">Nodes Clicked: <a id="seedlistdiv"></a></font>-->
<br><br><br><br>
